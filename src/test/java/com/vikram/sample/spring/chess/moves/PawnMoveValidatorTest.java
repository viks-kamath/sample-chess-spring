/**
* Test class for PawnMoveValidator 
*
...
public class PawnMoveValidatorTest {
	...
	public void testValidMove() {
		MoveValidator validator = MoveValidator.getInstance(position, "e7", "e5");
		assertTrue(validator.isValidMove());						
	}
	
	@Test
	public void testInvalidMove() {
		MoveValidator validator = MoveValidator.getInstance(position, "d7", "d5");
	...
	@Test
	public void testEnpassatCapture() {
		//TODO: Yet to complete
		fail();					
	}
